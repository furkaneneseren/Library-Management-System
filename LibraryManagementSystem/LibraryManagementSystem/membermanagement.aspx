<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="membermanagement.aspx.cs" Inherits="LibraryManagementSystem.membermanagement" %>
      ...
      <div class="row">
         <div class="col-md-5">
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                           <img width="100px" src="images/user-image-with-black-background.png" />
                        </center>
                     </div>
                  </div>
                  <div class="row">
            ...
            <a href="homepage.aspx"><< Back to Home</a><br>
             <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:elibraryDBConnectionString %>" SelectCommand="SELECT * FROM [member_tbl]"></asp:SqlDataSource>
            <br>
         </div>
         <div class="col-md-7">
            <div class="card">
