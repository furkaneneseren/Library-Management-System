...
namespace LibraryManagementSystem
{
    public partial class userprofile : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (Session["username"] != null && (Session["username"].ToString() == "" || Session["username"] == null))
                {
        ...
        void updateUserPersonalDetails()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("update member_tbl set fullname=@fullname, dob=@dob, contact_no=@contact_no, email=@email, state=@state, city=@city, pincode=@pincode, address=@address, password=@password, account_status=@account_status WHERE member_id='" + Session["username"].ToString().Trim() + "'", con);
